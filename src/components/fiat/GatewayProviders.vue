<template>
  <content-block :no-header="true" :shadow-light="true" :px0="true">
    <b-row class="card-provider px-4 py-2">
      ...
      <b-col lg="6">
        ...
        <div class="font-size-14 font-w400">
          MoonPay is a financial technology company that builds payments
          infrastructure for crypto. Our on-and-off-ramp suite of products
          provides a seamless experience for converting between fiat currencies
          and cryptocurrencies using all major payment methods.
        </div>
        <div class="mt-3 mb-2">
          <b-btn
            variant="primary"
      ...
      <b-col lg="4" class="container-border">
        ...
        <b-row class="check-list">
          <b-col>
            <div class="check-list__item">
              <font-awesome-icon icon="check-circle" /> Wire Transfer
            </div>
            <div class="check-list__item">
              <font-awesome-icon icon="check-circle" /> Credit Card
            </div>
            <div class="check-list__item">
              <font-awesome-icon icon="check-circle" /> Debit Card
            </div>
            <div class="check-list__item">
              <font-awesome-icon icon="check-circle" /> Apple Pay
            </div>
          </b-col>
          <b-col>
            <div class="check-list__item">
              <font-awesome-icon icon="check-circle" /> Google Pay
            </div>
            <div class="check-list__item">
              <font-awesome-icon icon="check-circle" /> Samsung Pay
            </div>
          </b-col>
        </b-row>
        <div class="check-header font-size-12 font-w600 mt-2 mb-1">
        ...
        <b-row class="check-list">
          <b-col>
            <div class="check-list__item">
              <font-awesome-icon icon="check-circle" /> Global
            </div>
          </b-col>
        </b-row>
      </b-col>
