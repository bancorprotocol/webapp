...
export class PrivacyPolicyModule extends VuexModule.With({
  ...
  contents: Array<{id: number, subtitle: string, subcontent: string}> = Array (
    {
      ...
      subtitle: "About Us",
      subcontent:
        "The Bancor Network (the “Bancor Network”, “We”, “Us” or “Our”) is a Decentralized Liquidity Network that allows you to hold any Ethereum token and convert it to any other token in the network, with no counter party, at an automatically calculated price, using a simple web wallet (the “Services”). This privacy policy has been created to inform about how we manage, collect, store and use the personal information we receive and collect in connection with the Bancor Network (the <code>Policy</code>)."
    },
    {
      id: 2,
